...
To derive the correct expression for the phonon SED, $\Phi$, we begin with harmonic lattice dynamics theory \cite{wallace1972,dove1993}. In reciprocal space, the system Hamiltonian, $H$, is
...
equilibrium distribution function \cite{maradudin1974,wallace1972}. The phonon mode coordinate for the mode described by ($\pmb{\kappa},\nu$) and its time
